...
export class Create1649593939351 implements MigrationInterface {
    name = 'Create1649593939351'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ITEM" ADD CONSTRAINT "FK_5b06cd921e14116ed1f5c4ab413" FOREIGN KEY ("categoryPk") REFERENCES "CATEGORY"("PK") ON DELETE CASCADE ON UPDATE NO ACTION`);
